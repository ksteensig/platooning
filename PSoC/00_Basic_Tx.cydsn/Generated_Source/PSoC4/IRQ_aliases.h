...
#define IRQ_0_PS		(IRQ__0__PS)
#define IRQ_0_PC		(IRQ__0__PC)
#define IRQ_0_DR		(IRQ__0__DR)
#define IRQ_0_SHIFT	(IRQ__0__SHIFT)
#define IRQ_0_INTR	((uint16)((uint16)0x0003u << (IRQ__0__SHIFT*2u)))
