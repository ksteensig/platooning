...
***************************************/
    ...
    #define SPI_SCLK_HSIOM_SEL_GPIO  (SPI_spi_sclk__0__HSIOM_GPIO)
    #define SPI_SCLK_HSIOM_SEL_I2C   (SPI_spi_sclk__0__HSIOM_I2C)
    #define SPI_SCLK_HSIOM_SEL_SPI   (SPI_spi_sclk__0__HSIOM_SPI)
    #define SPI_SCLK_HSIOM_SEL_UART  (SPI_spi_sclk__0__HSIOM_UART)
#endif /* (SPI_SCLK_PIN) */
    ...
    #define SPI_SS0_HSIOM_SEL_GPIO  (SPI_spi_ss0__0__HSIOM_GPIO)
    #define SPI_SS0_HSIOM_SEL_I2C   (SPI_spi_ss0__0__HSIOM_I2C)
    #define SPI_SS0_HSIOM_SEL_SPI   (SPI_spi_ss0__0__HSIOM_SPI)
#if !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1)
    #define SPI_SS0_HSIOM_SEL_UART  (SPI_spi_ss0__0__HSIOM_UART)
