// ======================================================================
// FirstTry.v generated from TopDesign.cysch
// 11/22/2018 at 14:03
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1600000, ADC_Input_Range=2, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=2.04, Ref_Voltage_mV=2040, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_A, CY_INSTANCE_SHORT_NAME=ADC_A, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=ADC_A, )
...
// Mixer_v2_0(LO_clock_freq=4000, LO_Source=1, Mixer_Type=1, Power=3, Signal_Frequency=40, Vdda_Value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Mixer_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Mixer_A, CY_INSTANCE_SHORT_NAME=Mixer_A, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Mixer_A, )
module Mixer_v2_0_2 (
    Fin,
    Fout,
    LO,
...
// Mixer_v2_0(LO_clock_freq=1600, LO_Source=1, Mixer_Type=1, Power=2, Signal_Frequency=3500, Vdda_Value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Mixer_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Mixer_PD_A, CY_INSTANCE_SHORT_NAME=Mixer_PD_A, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Mixer_PD_A, )
module Mixer_v2_0_3 (
    Fin,
    Fout,
    LO,
...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Comp_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp_PD_B, CY_INSTANCE_SHORT_NAME=Comp_PD_B, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Comp_PD_B, )
module Comp_v2_0_4 (
    Vplus,
    CmpOut,
    Vminus,
...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Comp_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp_PD_A, CY_INSTANCE_SHORT_NAME=Comp_PD_A, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Comp_PD_A, )
module Comp_v2_0_5 (
    Vplus,
    CmpOut,
    Vminus,
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1600000, ADC_Input_Range=2, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=2.04, Ref_Voltage_mV=2040, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_B, CY_INSTANCE_SHORT_NAME=ADC_B, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=ADC_B, )
...
// Mixer_v2_0(LO_clock_freq=4000, LO_Source=1, Mixer_Type=1, Power=3, Signal_Frequency=40, Vdda_Value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Mixer_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Mixer_B, CY_INSTANCE_SHORT_NAME=Mixer_B, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Mixer_B, )
module Mixer_v2_0_8 (
    Fin,
    Fout,
    LO,
...
// Mixer_v2_0(LO_clock_freq=1600, LO_Source=1, Mixer_Type=1, Power=2, Signal_Frequency=3500, Vdda_Value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Mixer_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Mixer_PD_B, CY_INSTANCE_SHORT_NAME=Mixer_PD_B, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Mixer_PD_B, )
module Mixer_v2_0_10 (
    Fin,
    Fout,
    LO,
    Vref);
...
module top ;
    ...
    Mixer_v2_0_2 Mixer_A (
        .Fin(Net_213),
        .Fout(Net_62),
        .LO(Net_59),
        .Vref(Net_60));

	wire [0:0] tmpOE__SignalA_net;
	wire [0:0] tmpFB_0__SignalA_net;
	wire [0:0] tmpIO_0__SignalA_net;
	wire [0:0] tmpINTERRUPT_0__SignalA_net;
	electrical [0:0] tmpSIOVREF__SignalA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		SignalA
		 (.oe(tmpOE__SignalA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SignalA_net[0:0]}),
		  .analog({Net_213}),
		  .io({tmpIO_0__SignalA_net[0:0]}),
		  .siovref(tmpSIOVREF__SignalA_net),
		  .interrupt({tmpINTERRUPT_0__SignalA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SignalA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Mixer_v2_0_3 Mixer_PD_A (
        .Fin(Net_213),
        .Fout(Net_208),
        .LO(Net_212),
        .Vref(Net_197));
    ...
    Comp_v2_0_5 Comp_PD_A (
        .Vplus(Net_213),
        .CmpOut(Net_59),
        .Vminus(Net_208),
        .clock(Net_212));

    USBFS_v3_10_6 USBUART_1 (
        .sof(Net_265),
        .vbusdet(1'b0));
    ...
    Mixer_v2_0_8 Mixer_B (
        .Fin(Net_236),
        .Fout(Net_154),
        .LO(Net_152),
        .Vref(Net_155));

	wire [0:0] tmpOE__SignalB_net;
	wire [0:0] tmpFB_0__SignalB_net;
	wire [0:0] tmpIO_0__SignalB_net;
	wire [0:0] tmpINTERRUPT_0__SignalB_net;
	electrical [0:0] tmpSIOVREF__SignalB_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cda8ed7d-e3b9-47cd-b183-a7bf7e1bc363"),
		  ...
		  .input_buffer_sel(2'b00))
		SignalB
		 (.oe(tmpOE__SignalB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SignalB_net[0:0]}),
		  .analog({Net_151}),
		  .io({tmpIO_0__SignalB_net[0:0]}),
		  .siovref(tmpSIOVREF__SignalB_net),
		  .interrupt({tmpINTERRUPT_0__SignalB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SignalB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
