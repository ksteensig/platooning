...
module top ;
	...
	cy_clock_v1_0
		#(.id("3b279238-0b61-49ce-a599-9d38abf88300"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
    ...
    UART_v2_50_5 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_273),
        .tx_interrupt(Net_274),
        .rx_interrupt(Net_275),
        .tx_data(Net_276),
        .tx_clk(Net_277),
        .rx_data(Net_278),
        .rx_clk(Net_279));
