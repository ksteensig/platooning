...
#define BS_PICU_7_VAL ((const uint8 CYFAR *)0x48000010u)
...
#define BS_CMP0_VAL ((const uint8 CYFAR *)0x48000020u)

/* CMP1 Address: CYREG_CMP1_SW0 Size (bytes): 8 */
#define BS_CMP1_VAL ((const uint8 CYFAR *)0x48000028u)

/* CMP2 Address: CYREG_CMP2_SW0 Size (bytes): 8 */
#define BS_CMP2_VAL ((const uint8 CYFAR *)0x48000030u)

/* CMP3 Address: CYREG_CMP3_SW0 Size (bytes): 8 */
#define BS_CMP3_VAL ((const uint8 CYFAR *)0x48000038u)

/* SC0 Address: CYREG_SC0_SW0 Size (bytes): 13 */
#define BS_SC0_VAL ((const uint8 CYFAR *)0x48000040u)

/* SC3 Address: CYREG_SC3_SW0 Size (bytes): 13 */
#define BS_SC3_VAL ((const uint8 CYFAR *)0x48000050u)

/* TMR0 Address: CYREG_TMR0_CFG0 Size (bytes): 12 */
#define BS_TMR0_VAL ((const uint8 CYFAR *)0x48000060u)

/* SAR1 Address: CYREG_SAR1_SW0 Size (bytes): 8 */
#define BS_SAR1_VAL ((const uint8 CYFAR *)0x4800006Cu)

/* UDB_1_2_0_CONFIG Address: CYDEV_UCFG_B0_P3_U1_BASE Size (bytes): 128 */
#define BS_UDB_1_2_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000074u)

/* UDB_0_2_1_CONFIG Address: CYDEV_UCFG_B0_P4_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_2_1_CONFIG_VAL ((const uint8 CYFAR *)0x480000F4u)

/* UDB_0_2_0_CONFIG Address: CYDEV_UCFG_B0_P4_U1_BASE Size (bytes): 128 */
#define BS_UDB_0_2_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000174u)

/* UDB_1_1_1_CONFIG Address: CYDEV_UCFG_B1_P3_U0_BASE Size (bytes): 128 */
#define BS_UDB_1_1_1_CONFIG_VAL ((const uint8 CYFAR *)0x480001F4u)

/* UDB_1_1_0_CONFIG Address: CYDEV_UCFG_B1_P3_U1_BASE Size (bytes): 128 */
#define BS_UDB_1_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000274u)

/* UDB_0_1_1_CONFIG Address: CYDEV_UCFG_B1_P4_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_1_1_CONFIG_VAL ((const uint8 CYFAR *)0x480002F4u)
...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 128u, 0x0Eu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P3_U0_BASE) },	/* TD 13 */
		{ 384u, 0x0Fu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_U0_BASE) },	/* TD 14 */
		{ 384u, 0x10u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_U0_BASE) },	/* TD 15 */
		...
		{ 128u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI1_BASE) },	/* TD 18 */
		{ 6u, 0x14u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PRTDSI_PRT12_BASE) },	/* TD 19 */
		{ 8u, 0x15u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PICU_INTTYPE_PICU12_BASE) },	/* TD 20 */
		{ 8u, 0x16u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_CMP0_SW0) },	/* TD 21 */
		{ 8u, 0x17u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_CMP1_SW0) },	/* TD 22 */
		{ 8u, 0x18u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_CMP2_SW0) },	/* TD 23 */
		{ 8u, 0x19u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_CMP3_SW0) },	/* TD 24 */
		{ 13u, 0x1Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_SC0_SW0) },	/* TD 25 */
		{ 13u, 0x1Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_SC3_SW0) },	/* TD 26 */
		{ 12u, 0x1Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_TMR0_CFG0) },	/* TD 27 */
		{ 8u, 0x1Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_SAR1_SW0) },	/* TD 28 */
		...
		{ 16u, 0x2Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_BCTL1_MDCLK_EN) },	/* TD 41 */
		{ 16u, 0x2Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_BCTL0_MDCLK_EN) },	/* TD 42 */
		{ 128u, 0x2Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE) },	/* TD 43 */
		{ 128u, 0x2Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE + 0x00000080u) },	/* TD 44 */
		{ 128u, 0x2Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE) },	/* TD 45 */
		{ 128u, 0x2Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE + 0x00000080u) },	/* TD 46 */
		{ 128u, 0x30u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI7_BASE) },	/* TD 47 */
		{ 128u, 0x31u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI7_BASE + 0x00000080u) },	/* TD 48 */
		{ 128u, 0x32u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI6_BASE) },	/* TD 49 */
		{ 128u, 0x33u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI6_BASE + 0x00000080u) },	/* TD 50 */
		{ 128u, 0x34u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI5_BASE) },	/* TD 51 */
		{ 128u, 0x35u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI5_BASE + 0x00000080u) },	/* TD 52 */
		{ 128u, 0x36u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI4_BASE) },	/* TD 53 */
		{ 128u, 0x37u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI4_BASE + 0x00000080u) },	/* TD 54 */
		{ 128u, 0x38u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_ROUTE_BASE) },	/* TD 55 */
		{ 128u, 0x39u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_ROUTE_BASE + 0x00000080u) },	/* TD 56 */
		{ 128u, 0x3Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_ROUTE_BASE + 0x00000080u) },	/* TD 57 */
		{ 128u, 0x3Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P4_ROUTE_BASE) },	/* TD 58 */
		{ 128u, 0x3Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P4_ROUTE_BASE + 0x00000080u) },	/* TD 59 */
		{ 128u, 0x3Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_ROUTE_BASE) },	/* TD 60 */
		{ 128u, 0x3Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_ROUTE_BASE + 0x00000080u) },	/* TD 61 */
		{ 128u, 0x3Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P4_ROUTE_BASE) },	/* TD 62 */
		{ 128u, 0x40u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P4_ROUTE_BASE + 0x00000080u) },	/* TD 63 */
		{ 128u, 0x41u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P3_ROUTE_BASE) },	/* TD 64 */
		{ 128u, 0x42u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P3_ROUTE_BASE + 0x00000080u) },	/* TD 65 */
		{ 128u, 0x43u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE + 0x00000080u) },	/* TD 66 */
		{ 128u, 0x44u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_ROUTE_BASE + 0x00000080u) },	/* TD 67 */
		...
		{ 128u, 0x47u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI9_BASE) },	/* TD 70 */
		{ 128u, 0x48u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI9_BASE + 0x00000080u) },	/* TD 71 */
		{ 128u, 0x49u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI8_BASE) },	/* TD 72 */
		{ 128u, 0x4Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI8_BASE + 0x00000080u) },	/* TD 73 */
		{ 128u, 0x4Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE) },	/* TD 74 */
		{ 128u, 0x4Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE + 0x00000080u) },	/* TD 75 */
		{ 128u, 0x4Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI2_BASE) },	/* TD 76 */
		{ 128u, 0x4Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI2_BASE + 0x00000080u) },	/* TD 77 */
		{ 128u, 0x4Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI1_BASE + 0x00000080u) },	/* TD 78 */
		{ 128u, 0x50u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE) },	/* TD 79 */
		{ 128u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE + 0x00000080u) },	/* TD 80 */
	};
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_PICU_7_VAL),	/* TD 20 */
		(const void *)(BS_CMP0_VAL),	/* TD 21 */
		(const void *)(BS_CMP1_VAL),	/* TD 22 */
		(const void *)(BS_CMP2_VAL),	/* TD 23 */
		(const void *)(BS_CMP3_VAL),	/* TD 24 */
		(const void *)(BS_SC0_VAL),	/* TD 25 */
		(const void *)(BS_SC3_VAL),	/* TD 26 */
		(const void *)(BS_TMR0_VAL),	/* TD 27 */
		(const void *)(BS_SAR1_VAL),	/* TD 28 */
		...
		(const void *)(BS_UCFG_BCTL1_VAL),	/* TD 41 */
		(const void *)(BS_UCFG_BCTL0_VAL),	/* TD 42 */
		(const void *)(BS_DSISWITCH_0_0_VAL),	/* TD 43 */
		(const void *)(BS_DSI0_0_HV_ROUTING_VAL),	/* TD 44 */
		(const void *)(BS_DSISWITCH_0_1_VAL),	/* TD 45 */
		(const void *)(BS_DSI0_1_HV_ROUTING_VAL),	/* TD 46 */
		(const void *)(BS_DSISWITCH_0_2_VAL),	/* TD 47 */
		...
		(const void *)(BS_DSISWITCH_0_5_VAL),	/* TD 53 */
		(const void *)(BS_DSI0_5_HV_ROUTING_VAL),	/* TD 54 */
		(const void *)(BS_UDBSWITCH_0_0_VAL),	/* TD 55 */
		(const void *)(BS_UDB_1_0_HV_ROUTING_VAL),	/* TD 56 */
		(const void *)(BS_UDB_2_0_HV_ROUTING_VAL),	/* TD 57 */
		(const void *)(BS_UDBSWITCH_0_1_VAL),	/* TD 58 */
		(const void *)(BS_UDB_1_1_HV_ROUTING_VAL),	/* TD 59 */
		(const void *)(BS_UDBSWITCH_1_1_VAL),	/* TD 60 */
		(const void *)(BS_UDB_2_1_HV_ROUTING_VAL),	/* TD 61 */
		(const void *)(BS_UDBSWITCH_0_2_VAL),	/* TD 62 */
		(const void *)(BS_UDB_1_2_HV_ROUTING_VAL),	/* TD 63 */
		(const void *)(BS_UDBSWITCH_1_2_VAL),	/* TD 64 */
		...
		(const void *)(BS_DSISWITCH_1_2_VAL),	/* TD 74 */
	...
	CY_SET_REG16((void CYXDATA *)CYREG_PHUB_TDMEM0_ORIG_TD0, 80u*8u);	/* transfer size */
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BG_CR0, 0x02u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR0_CSR1, 0x60u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP1_SW0, 0x88u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP1_SW3, 0x20u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP1_SW4, 0x01u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP2_SW0, 0x82u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0x24u);
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_SAR1_SW2, 0x2004u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW0, 0x79u);
