...
# Date: Tue, 15 Jan 2019 12:16:33 GMT
#set_units -time ns
...
create_clock -name {ADC_SAR_B_theACLK(fixed-function)} -period 125 -waveform {0 62.5} [get_pins {ClockBlock/aclk_glb_ff_0}]
...
create_clock -name {ADC_SAR_A_theACLK(fixed-function)} -period 125 -waveform {0 62.5} [get_pins {ClockBlock/aclk_glb_ff_1}]
...
create_generated_clock -name {Clock_1} -source [get_pins {ClockBlock/clk_sync}] -edges {1 13 25} [list [get_pins {ClockBlock/dclk_glb_3}]]
...
create_clock -name {Clock_2(fixed-function)} -period 1000 -waveform {0 41.6666666666667} [get_pins {ClockBlock/dclk_glb_ff_4}]
...
# Project: C:\Users\Krist\OneDrive\Dokumenter\GitHub\platooning\PSoC\Platooning\AngleMeasurement.cydsn\AngleMeasurement.cyprj
# Date: Tue, 15 Jan 2019 12:16:10 GMT
