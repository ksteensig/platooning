...
module ADC_SAR_v3_10_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("1ac789f5-0007-4895-bdd5-a5e5bbb658ab/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module ADC_SAR_v3_10_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("f9058b8e-d0dc-44db-aebd-7bbf77dedb1b/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    assign Net_115 = Net_110 | Net_111;
    ...
    assign Net_114 = Net_115 & Net_118;
	...
	cy_clock_v1_0
		#(.id("95135e20-5300-487d-88c2-8076e39d6796"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("250000000"),
		  .is_direct(0),
    ...
    defparam Status_Reg.NumInputs = 8;
