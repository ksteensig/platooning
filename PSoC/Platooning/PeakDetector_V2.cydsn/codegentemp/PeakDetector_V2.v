// ======================================================================
// PeakDetector_V2.v generated from TopDesign.cysch
// 11/27/2018 at 09:44
...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("1ac789f5-0007-4895-bdd5-a5e5bbb658ab/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module ADC_SAR_v3_10_2 (
	...
	cy_clock_v1_0
		#(.id("f9058b8e-d0dc-44db-aebd-7bbf77dedb1b/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("833333333.333333"),
		  .is_direct(0),
...
// Sample_Hold_v1_40(Power=3, Sample_Clock_Edge=1, Sample_Mode=1, Vdda_Value=5, Vref_Type=2, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Sample_Hold_v1_40, CY_CONFIG_TITLE=Sample_Hold_B, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Sample_Hold_B, CY_INSTANCE_SHORT_NAME=Sample_Hold_B, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=40, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Sample_Hold_B, )
...
// Sample_Hold_v1_40(Power=3, Sample_Clock_Edge=1, Sample_Mode=1, Vdda_Value=5, Vref_Type=2, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Sample_Hold_v1_40, CY_CONFIG_TITLE=Sample_Hold_A, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Sample_Hold_A, CY_INSTANCE_SHORT_NAME=Sample_Hold_A, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=40, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Sample_Hold_A, )
module Sample_Hold_v1_40_4 (
    sclk,
    Vin,
    Vout,
    Vref);
...
module top ;
    ...
    UART_v2_50_0 UART (
        ...
        .reset(1'b0),
        .rx(Net_390),
        .tx_interrupt(Net_391),
        .rx_interrupt(Net_392),
        .tx_data(Net_393),
        .tx_clk(Net_394),
        .rx_data(Net_395),
        .rx_clk(Net_396));
    ...
    assign Net_416 = Net_370 & Net_63;


	cy_clock_v1_0
		#(.id("c2b6fb14-ba45-445d-8042-09c12bcbcbf4"),
    ...
    Sample_Hold_v1_40_3 Sample_Hold_B (
        .sclk(Net_416),
        .Vin(Net_383),
        .Vout(Net_419),
        .Vref(Net_413));

    Sample_Hold_v1_40_4 Sample_Hold_A (
        .sclk(Net_416),
        .Vin(Net_378),
        .Vout(Net_52),
        .Vref(Net_382));
    ...
    assign Net_325 = Net_110 | Net_111;
    ...
    assign Net_114 = Net_325 & Net_118;
	...
	cy_psoc3_pins_v1_10
		#(.id("2fe8b180-6d1e-4c98-9fca-98b5fd08c457"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c01ae8a1-f13c-40d5-b53b-1ceb67a4f516"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
