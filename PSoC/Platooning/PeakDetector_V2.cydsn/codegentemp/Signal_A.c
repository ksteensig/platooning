...
*
* \funcusage
*  \snippet Signal_A_SUT.c usage_Signal_A_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Signal_A_SUT.c usage_Signal_A_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Signal_A_SUT.c usage_Signal_A_Read  
*******************************************************************************/
...
* preferred Signal_A_Read() API because the 
* Signal_A_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Signal_A_SUT.c usage_Signal_A_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Signal_A_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Signal_A_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Signal_A_0_INTR       (First pin in the list)
    *  - Signal_A_1_INTR       (Second pin in the list)
    *  - ...
    *  - Signal_A_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Signal_A_SUT.c usage_Signal_A_SetInterruptMode
    *******************************************************************************/
    void Signal_A_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Signal_A_0_INTR) != 0u) 
		{ 
			 Signal_A_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Signal_A_SUT.c usage_Signal_A_ClearInterrupt
    *******************************************************************************/
